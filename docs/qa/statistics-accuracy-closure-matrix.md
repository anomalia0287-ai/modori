...
1. Run the independent adversarial review of the binary logistic closure
   candidate before integration.
2. Keep remaining work limited to explicit scope-expansion decisions:
