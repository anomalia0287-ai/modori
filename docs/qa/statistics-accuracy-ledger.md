...
- Local calculation-reliability gate:
  ...
  `launch-smoke-ok`, full pytest `1001 passed, 6 skipped`, `pip check`, and
  slow statistics pytest `3 passed, 1004 deselected`.
- Host quality gate:
...
- Slow bootstrap adequacy smoke:
  `scripts\slow_stats_gate.py` reported `3 passed, 1004 deselected` for
