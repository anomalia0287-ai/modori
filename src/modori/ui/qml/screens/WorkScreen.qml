        ...
        PearlSurface {
            ...
            RowLayout {
                ...
                AppButton {
                    ...
                    Accessible.name: text
                    Accessible.description: root.researchRailOpen
                        ? appBootstrap.text("research.close_description", appBootstrap.language)
                        : appBootstrap.text("research.open_description", appBootstrap.language)
                    variant: "quiet"
                    compact: true
